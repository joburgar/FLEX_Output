...
writeRaster(clipped_raster1, "Quesnel_Cariboo.tif", datatype = "INT4S",overwrite=TRUE) # for large rasters, need to provide data type
writeRaster(clipped_raster2, "Quesnel_Chicotin.tif", datatype = "INT4S",overwrite=TRUE) # for large rasters, need to provide data type
